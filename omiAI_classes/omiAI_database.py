...
# Danger zone: ooo scary file managment stuff this will def fold under zero pressure
...
class omiDB:
    ...
    def loadIntoMemory(self, file):
        if self.fileExists(file):
            ...
            logger.error("omiDB.loadIntoMemory: Couldn't load file that doesn't even exist")
            raise Exception("omiDB.loadIntoMemory: Couldn't load file that doesn't even exist")
